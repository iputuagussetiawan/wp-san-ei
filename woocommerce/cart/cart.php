...
<h1 class="cart-title section-title"><?php echo pll__('Cart')?></h1>
...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table" cellspacing="0">
		...
		<tbody>
			...
			<tr class="coupon-holder-wrapper">
				<td colspan="3" class="actions coupon-holder">
...
<div class="cart-collaterals row justify-content-end">
