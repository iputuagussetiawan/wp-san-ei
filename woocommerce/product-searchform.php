...
">
    <div class="search-box__inner">
        <input type="search" id="woocommerce-product-search-field-<?php echo isset( $index ) ? absint( $index ) : 0; ?>" class="search-field form-control text search-input search-box__input" placeholder="<?php echo esc_attr__( 'Search All Products', 'woocommerce' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
